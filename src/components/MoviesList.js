...
const MovieList = ({
  ...
  return (
    <>
      <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 row-cols-xl-4 row-cols-xxl-5 g-4">
        {movieList.map((movie) => (
          <div className="col" id="movieListCard" key={movie.id}>
